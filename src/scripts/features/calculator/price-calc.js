...
const SERVICE_CONFIGS = {
  ...
  plastering: {
    ...
    rates: {
      "Под обои": { base: 600, type: "Гипсовая штукатурка по маякам" },
      "Под покраску": { base: 650, type: "Гипсовая штукатурка под покраску" },
      "Под плитку": { base: 650, type: "Цементная штукатурка" },
      "Не знаю — подскажите": { base: 600, type: "Гипсовая штукатурка по маякам" },
    },
    propertyMultiplier: {
      "Квартира / новостройка": 1.0,
      "Частный дом / коттедж": 1.0,
  ...
  "soft-roofing": {
    quizLabel: "Квиз-расчёт мягкой кровли:",
    miniCalcLabel: "Мини-калькулятор мягкой кровли:",
    coatingFieldLabel: "Материал",
    rates: {
      "Гибкая черепица": { base: 650, type: "Гибкая черепица под ключ" },
      "ПВХ-мембрана": { base: 700, type: "ПВХ-мембрана" },
      "Наплавляемая кровля": { base: 350, type: "Наплавляемая кровля" },
      "Не знаю — подскажите": { base: 600, type: "Подберём при выезде" },
    },
    propertyMultiplier: {
      "Простая скатная крыша": 1.0,
      "Плоская крыша / гараж": 1.0,
      "Сложная крыша с ендовами и узлами": 1.3,
      "Не знаю — подскажите": 1.1,
    },
  },
  "airless-painting": {
    quizLabel: "Квиз-расчёт безвоздушной покраски:",

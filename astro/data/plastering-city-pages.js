...
function citySeo(city) {
  ...
  return {
    ...
    description: `Машинная штукатурка стен в ${city.nameIn}: гипсовая и цементная, по маякам. От 600 ₽/м², гарантия 3 года, договор и акт.`,
    canonical,
    ogTitle: `Штукатурные работы в ${city.nameIn} | ROSA — Машинная штукатурка под ключ`,
    ogDescription: `Профессиональная штукатурка стен в ${city.nameIn}: от 600 ₽/м², гипсовая и цементная штукатурка по маякам, договор и гарантия 3 года.`,
...
function serviceJsonLd(city, seo) {
  return buildServiceJsonLd({
    ...
    description: `Машинная штукатурка стен в ${city.nameIn} и Московской области. Гипсовая и цементная штукатурка по маякам, фасады, смета, договор, акт и гарантия 3 года.`,
    areaServed: {
      "@type": "City",
      name: city.name,
      containedInPlace: {

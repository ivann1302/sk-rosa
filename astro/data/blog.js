...
export const blogArticles = [
  ...
  },
  {
    ...
    excerpt:
      "Вы стоите с аппаратом для безвоздушного напыления и думаете: какая краска не забьет сопло, ляжет ровно и не отслоится через год? Выбираем подходящую краску для безвоздушной покраски за 5 минут.",
    date: "2026-02-09",
    dateLabel: "9 февраля 2026",
    readTime: "4 мин чтения",

...
function citySeo(city) {
  ...
  return {
    ...
    description: `Полусухая и цементная стяжка пола в ${city.nameIn}. От 900 ₽/м², лазерный контроль, гарантия 3 года, договор и акт.`,
    canonical,
    ogTitle: `Стяжка пола в ${city.nameIn} | ROSA — Профессиональная стяжка под ключ`,
    ogDescription: `Профессиональная стяжка пола в ${city.nameIn}: от 900 ₽/м², полусухая и цементная стяжка, договор и гарантия 3 года.`,
...
function serviceJsonLd(city, seo) {
  return buildServiceJsonLd({
    ...
    description: `Механизированная стяжка пола в ${city.nameIn} и Московской области. Полусухая и цементная стяжка, лазерный контроль ровности, договор, акт и гарантия 3 года.`,
    areaServed: {
      "@type": "City",
      name: city.name,
      containedInPlace: {

...
export const plasteringPage = {
  seo: {
    ...
    ogDescription:
      "Профессиональные штукатурные работы в Москве и МО. Штукатурка стен и потолков по маякам, цена от 600 ₽/м², договор и гарантия.",
  ...
  hero: {
    ...
    badges: ["от 600 ₽/м²", "гарантия 3 года", "договор и акт"],
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Передаём договор, согласованную смету и акт выполненных работ. При сдаче показываем качество поверхности и фиксируем принятый объём.",
    },
  ],
  articles: [
    {
...
export const plasteringJsonLd = serviceJsonLd({
  ...
  description:
    "Механизированная штукатурка стен в Москве и Московской области. Гипсовая и цементная штукатурка по маякам, смета, договор, акт и гарантия.",
  areaServed: [

...
export const plasteringPage = {
  ...
  textBlock: {
    title: "Механизированная штукатурка стен под ключ в Москве и МО",
    subtitle: "Гипсовая и цементная штукатурка - от замера до сдачи под чистовую отделку",
    paragraphs: [
      "Основные заказчики — владельцы квартир в новостройках, частных домов и коммерческих объектов: коттеджей, офисов, магазинов и небольших производств. Машинная подача смеси через штукатурную станцию даёт скорость до 200 м² за смену и помогает держать одинаковое качество на большом объёме.",

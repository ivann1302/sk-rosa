...
export const plasteringPage = {
  seo: {
    ...
    description:
      "Гипсовая и цементная штукатурка стен в Москве ➤ Машинное нанесение, работа с маяками. Цена от 600 руб/м². Бесплатный замер. ☎ 8(985) 135-49-91",
    ...
    ogDescription:
      "Профессиональные штукатурные работы в Москве и МО. Штукатурка стен и потолков, выравнивание поверхностей. Цена от 600 руб Гарантия качества.",

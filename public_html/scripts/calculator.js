...
class Calculator {
  ...
  calculate() {
    ...
    const visibleRoomInputs = document.querySelectorAll('.calculator-results__room:not(.hidden) .calculator-results__input');
    const visibleRoomPrices = document.querySelectorAll('.calculator-results__room:not(.hidden) .calculator-results__price');
  ...
  updateRoomAreas(totalArea, objectType) {
    ...
    const roomInputs = document.querySelectorAll('.calculator-results__room:not(.hidden) .calculator-results__input');

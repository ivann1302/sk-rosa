...
**ОБЯЗАТЕЛЬНО:** После выполнения каждого промпта пользователя, файл `HOW-IT-WORK.md` должен быть **полностью перезаписан** с описанием логики работы нового/изменённого кода.
